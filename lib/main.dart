                                  ...
                                  if (form.currentState.validate()) {
                                    db
                                        ...
                                        .catchError((error) => print(
                                            "Falha ao cadastrar o usuário: $error"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        CartoesArea('Area de teste1', 1),
        CartoesArea('Area de teste2', 2),
        CartoesArea('Area de teste3', 3),
        CartoesArea('Area de teste4', 4),
      ]),
    );
  }
}
    ...
    return new Padding(
      ...
      child: Column(children: <Widget>[
        ...
        TextField(
          autofocus: true,
          decoration: InputDecoration(
              border: InputBorder.none, hintText: 'Informe o CNPJ'),
        ),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
              border: InputBorder.none, hintText: 'Informe o tempo de empresa'),
        ),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
              border: InputBorder.none, hintText: 'O negócio é familiar?'),
        ),
        Radiobutton(),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
              border: InputBorder.none, hintText: 'Informe o endereço'),
        ),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
              border: InputBorder.none, hintText: 'Informe a cidade'),
        ),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
              border: InputBorder.none, hintText: 'Informe o estado'),
        ),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
        ...
        TextField(
          ...
          decoration: InputDecoration(
              border: InputBorder.none,
              hintText:
                  'Qual é a seguimentação de nicho de mercado da empresa?'),
        ),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
              border: InputBorder.none,
              hintText:
                  'Informe uma especialidade que você acredita necessitar de assessoria. (Ex: Contabilidade, E-commerce, financeiro, etc).'),
        ),
        TextField(
          autofocus: true,
          decoration: InputDecoration(
          ...
          body: Padding(
              ...
              child: Center(
                ...
                children: <Widget>[
                  ...
                  Text(
                      "Você poderá acompanhar seu processo nessa tela na parte Status"),
                  SizedBox(
                    height: 20,
                  ),
                  Divider(),
                  ...
                  Divider(),
                  Text(
                      "Obs:.Enquanto isso você poderá assistir os cursos disponíveis na tela cursos"),
                  Text(
                      "Obs:.A tela consultoria só será habilitada sua solicitação for aprovada "),
                ],
              )))),
    );
  }
